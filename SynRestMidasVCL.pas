...
type
  ...
  protected
    fDataConvertPatchBackup: TPatchCode;
    ...
    // from TDataSet
    procedure DataConvertPatch(Field: TField; Source, Dest: Pointer; ToNative: Boolean);
...
// patch Delphi function
function NativeToDateTime(DataType: TFieldType; Data: TDateTimeRec): TDateTime; {$ifdef HASINLINE}inline;{$endif}
var
...
procedure TSynRestDataSet.DataConvertPatch(Field: TField; Source, Dest: Pointer; ToNative: Boolean);
begin
