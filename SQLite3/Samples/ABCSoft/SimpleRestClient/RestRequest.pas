...
begin
  ...
  try
    ...
    try
      ...
      //httpClient.Request.ContentType := 'application/x-www-form-urlencoded';
      httpClient.Request.UserAgent:= 'Mozilla/3.0';
      httpClient.Request.AcceptLanguage := 'en-GB,en;q=0.5';
      ...
      //params := TStringStream.Create('Name=aaaaa', TEncoding.UTF8);
